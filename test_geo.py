...
coord1,coord2,coord3 = (-3.0, 4.0),(1.0,0.0),(0.0,3.0)
trange1,trange2,trange3 = (-2.3, 3.4),(-3.0,3.0),(2.4,6.8)
...
def test_stations_by_distance():
    ...
    test = stations_by_distance(s, 0.0)
    for i in len(test) - 1:
...
def test_stations_within_radius():
    ...
    assert stations_within_radius(s, (0.0,0.0), 2.0) == ["station2"]
...
def test_stations_by_river():
    ...
    assert stations_by_river(s) == {s1: "River X", s2: "River Y", s3: "River X"}
